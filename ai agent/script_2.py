...
# Create a troubleshooting guide for the import error
guide = """# Troubleshooting: Import Error Solution
...
with open('IMPORT_ERROR_FIX.md', 'w', encoding='utf-8') as f:
    f.write(guide)

print("✅ Created troubleshooting guide: IMPORT_ERROR_FIX.md")
print("\n" + "="*60)
print("SOLUTION FOR YOUR IMPORT ERROR")
print("="*60)
print("\n📦 New file created:")
print("   → qs_ranking_workflow_simple.json (USE THIS ONE)")
print("\n📋 Two options to proceed:")
print("\n   Option 1: Import the simplified JSON")
print("   - Use qs_ranking_workflow_simple.json")
print("   - Much cleaner structure, should import successfully")
print("\n   Option 2: Build manually in n8n")
print("   - Follow the step-by-step guide in IMPORT_ERROR_FIX.md")
print("   - Most reliable if JSON import keeps failing")
print("\n💡 The simplified version:")
print("   ✓ Minimal structure to avoid import errors")
print("   ✓ Core functionality intact")
print("   ✓ You'll add export node manually after import")
print("\nRead IMPORT_ERROR_FIX.md for complete instructions!")
