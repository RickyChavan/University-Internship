...
# Create setup guide for HTTP Request workflow
guide = """# Setup Guide: QS Ranking Workflow (HTTP Request Method)
...
with open('HTTP_REQUEST_SETUP.md', 'w', encoding='utf-8') as f:
    f.write(guide)

print("✅ Setup guide created: HTTP_REQUEST_SETUP.md\n")
print("="*70)
print("SOLUTION: Use HTTP Request Instead of OpenAI Node")
print("="*70)
print("\n📦 New workflow file: qs_ranking_http_request.json")
print("📚 Setup guide: HTTP_REQUEST_SETUP.md")
print("\n✅ This method:")
print("  • No community node installation needed")
print("  • Works on any n8n version")
print("  • Uses built-in HTTP Request node")
print("  • Same functionality as OpenAI node")
print("\n🔑 You just need your OpenAI API key!")
print("\n📖 Read HTTP_REQUEST_SETUP.md for complete setup instructions")
